...
#include "newmatio.h"
 ...
 namespace COSTFNS {
  ...
  float normcorr_fully_weighted(const volume& vref, const volume& vtest,
				const volume& refweight, 
				const volume& testweight,
				const Matrix& aff, const float smoothsize)
    {
	...
	a31=iaff(3,1), a32=iaff(3,2), a33=iaff(3,3), a34=iaffbig(3,4), o1,o2,o3;
      ...
      float wval, smoothx, smoothy, smoothz, weight;
      smoothx = smoothsize / vtest.getx();
      smoothy = smoothsize / vtest.gety();
      smoothz = smoothsize / vtest.getz();
  ...
  float leastsquares_fully_weighted(const volume& vref, const volume& vtest,
				    const volume& refweight, 
				    const volume& testweight,
				    const Matrix& aff, const float smoothsize)
  {
  ...
  ///////////////////////////////////////////////////////////////////////
   ...
   void calc_fully_weighted_entropy(const volume& vref, const volume& vtest,
				    const volume& refweight, 
				    const volume& testweight,
				    int *bindex,  const Matrix& aff,
				    const float mintest, const float maxtest,
				    ...
				    const float fuzzyfrac)
   {
	...
	a31=iaff(3,1), a32=iaff(3,2), a33=iaff(3,3), a34=iaffbig(3,4), o1,o2,o3;
      ...
      float wval, smoothx, smoothy, smoothz;
  ...
  float mutual_info_fully_weighted(const volume& vref, const volume& vtest,
				    const volume& refweight, 
				    const volume& testweight,
			     int *bindex, const Matrix& aff,
			     const float mintest, const float maxtest,
  ...
  float normalised_mutual_info_fully_weighted(const volume& vref, 
					      const volume& vtest,
					      const volume& refweight, 
					      const volume& testweight,
			       int *bindex, const Matrix& aff,
  ...
  float normcorr_fully_weighted(const imagepair* ims, const Matrix& aff,
				...
				const volume& testweight) 
   {
     return normcorr_fully_weighted(ims->refvol,ims->testvol,
  ...
  float leastsquares_smoothed(const imagepair* ims, const Matrix& aff) 
   ...
   float leastsquares_fully_weighted(const imagepair* ims, const Matrix& aff, 
				     ...
				     const volume& testweight) 
   {
     return leastsquares_fully_weighted(ims->refvol,ims->testvol,
					refweight,testweight,
					aff,ims->smoothsize);
   }
  ...
  float mutual_info_fully_weighted(imagepair* ims, const Matrix& aff,
				   ...
				   const volume& testweight)
    {
      return mutual_info_fully_weighted(ims->refvol,ims->testvol,
				  refweight,testweight,
				  ims->bindex,aff,
				  ims->testmin,ims->testmax,
				  ims->no_bins,ims->fjointhist,
  ...
  float normalised_mutual_info_fully_weighted(imagepair* ims, const Matrix& aff,
					      ...
					      const volume& testweight)
    {
      return normalised_mutual_info_fully_weighted(ims->refvol,ims->testvol,
						   refweight,testweight,
						   ims->bindex,aff,
						   ims->testmin,ims->testmax,
						   ims->no_bins,ims->fjointhist,
